...
function reiniciarJogo() {
    ...
    tentativasRestantes = 30; // Define o número de tentativas
...
function verificarPalpite() {
    ...
    if (palpite < 1 || palpite > 100) {
        document.getElementById('resultado').innerText = 'insira um número entre 1 e 100.';
    ...
    if (palpite == numeroAleatorio) {
        ...
        document.getElementById('resultado').innerText = 'Meu deus!você é uma lenda!: ' + numeroAleatorio;
        ...
        document.getElementById('resultado').innerText = 'não desista!Sei que você consegue!';
        document.getElementById('tentativas').innerText = 'Tentativas restantes: ' + tentativasRestantes;
    }
